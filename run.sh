...
$PYTHON -m uvicorn --host 127.0.0.1 --port=6969 main:app & \
lt --host http://kekpower.ml:1234 --port 6969 & \
ngrok http 6969 & \
cloudflared tunnel --url localhost:6969 & \
./expose --quiet -q share http://127.0.0.1:6969 --auth="username:password" --server-host=kekpower.ml --server-port=80
